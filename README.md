# The Old Smugglers Club – Version 4.1.8
...
Für Version 4.1.8 gilt die Datei `GITHUB-UPDATE-4.1.7.md`. Gleichnamige Dateien werden beim Hochladen ersetzt. Es müssen keine Dateien gelöscht werden.
...
- `RELEASE_NOTES_v4.1.8.md` – Änderungen dieses Releases
