# The Old Smugglers Club – Version 4.3.4
...
Für Version 4.3.4 gilt die Datei `GITHUB-UPDATE-4.3.4.md`. Gleichnamige Dateien werden beim Hochladen ersetzt. Es müssen keine Dateien gelöscht werden.
...
- `RELEASE_NOTES_v4.3.4.md` – Änderungen dieses Releases
- `GITHUB-UPDATE-4.3.4.md` – konkrete Upload-Liste
