...
Aktueller Stand: **3.0.2 – Daten- und Wartungsoptimierung**
...
Für Updates muss nicht zwingend das komplette Paket erneut hochgeladen werden. Die Datei `GITHUB-UPDATE-3.0.2.md` nennt exakt, welche Dateien ersetzt, neu hinzugefügt oder gelöscht werden müssen.
