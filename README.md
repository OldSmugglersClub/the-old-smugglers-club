# The Old Smugglers Club – Version 4.3.6
...
Für Version 4.3.6 gilt die Datei `GITHUB-UPDATE-4.3.6.md`. Gleichnamige Dateien werden beim Hochladen ersetzt. Es müssen keine Dateien gelöscht werden.
...
- `RELEASE_NOTES_v4.3.6.md` – Änderungen dieses Releases
- `GITHUB-UPDATE-4.3.6.md` – konkrete Upload-Liste
