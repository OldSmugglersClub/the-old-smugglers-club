...
status = "OK" if not missing and not json_errors and not missing_required and version == "4.0.2" else "FEHLER"
report = {
    "auditVersion": "4.0.2",
