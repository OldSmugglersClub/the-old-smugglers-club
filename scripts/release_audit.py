...
required = ["index.html", "VERSION.txt", "CHANGELOG.md", "README.md", "datenregister.json", "datenmodell.js", "RELEASE-MANIFEST.json", "admin.html", "admin.css", "admin.js", "wettbewerbspflege.html", "wettbewerbspflege.css", "wettbewerbspflege.js"]
...
status = "OK" if not missing and not json_errors and not missing_required and version == "3.9" else "FEHLER"
report = {
    "auditVersion": "3.9",
