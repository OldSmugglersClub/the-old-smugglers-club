...
required = ["index.html", "VERSION.txt", "CHANGELOG.md", "README.md", "datenregister.json", "datenmodell.js", "RELEASE-MANIFEST.json", "admin.html", "admin.css", "admin.js", "wettbewerbspflege.html", "wettbewerbspflege.css", "wettbewerbspflege.js", "team-teilnehmerpflege.html", "team-teilnehmerpflege.css", "team-teilnehmerpflege.js", "teilnehmer.json"]
...
status = "OK" if not missing and not json_errors and not missing_required and version == "3.10" else "FEHLER"
report = {
    "auditVersion": "3.10",
