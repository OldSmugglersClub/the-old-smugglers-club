...
required = ["index.html", "VERSION.txt", "CHANGELOG.md", "README.md", "datenregister.json", "datenmodell.js"]
...
status = "OK" if not missing and not json_errors and not missing_required and version == "2.48" else "FEHLER"
report = {
    "auditVersion": "2.48",
