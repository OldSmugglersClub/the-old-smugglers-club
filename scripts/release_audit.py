...
required = ["index.html", "VERSION.txt", "CHANGELOG.md", "README.md", "datenregister.json", "datenmodell.js", "RELEASE-MANIFEST.json"]
...
status = "OK" if not missing and not json_errors and not missing_required and version == "3.0.2" else "FEHLER"
report = {
    "auditVersion": "3.0.2",
